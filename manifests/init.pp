...
class wso2brs (
  ...
  $post_install_resources    = $wso2brs::params::post_install_resources,
  $post_configure_resources  = $wso2brs::params::post_configure_resources,
  $post_start_resources      = $wso2brs::params::post_start_resources
